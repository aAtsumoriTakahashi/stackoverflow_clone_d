...
defmodule StackoverflowCloneD.Controller.Book.UpdateRequestBody do
...
defmodule StackoverflowCloneD.Controller.Book.Update do
  use StackoverflowCloneD.Controller.Application
  alias Sazabi.G2gClient
  alias StackoverflowCloneD.Dodai, as: SD
  alias StackoverflowCloneD.Error.{BadRequestError, ResourceNotFoundError}
  alias StackoverflowCloneD.Controller.Book.{Helper, UpdateRequestBody}
