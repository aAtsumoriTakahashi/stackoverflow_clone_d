...
defmodule StackoverflowCloneD.Controller.Book.IndexRequestParams do
...
defmodule StackoverflowCloneD.Controller.Book.Index do
  ...
  alias StackoverflowCloneD.Controller.Book.{Helper, IndexRequestParams}
