defmodule StackoverflowCloneD.Controller.Book.IndexTest do
  use StackoverflowCloneD.CommonCase
  alias Dodai.RetrieveDedicatedDataEntityListRequestQuery, as: Query
  alias Sazabi.G2gClient
  alias StackoverflowCloneD.Controller.Book.Index
  alias StackoverflowCloneD.Controller.Book.IndexRequestParams
  alias StackoverflowCloneD.TestData.BookData
